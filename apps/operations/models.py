...
class UserLove(models.Model):
    love_man = models.ForeignKey(UserProfile, models.CASCADE, verbose_name="收藏用户")
...
class UserCourse(models.Model):
    study_man = models.ForeignKey(UserProfile, models.CASCADE, verbose_name="学习用户")
    study_course = models.ForeignKey(CourseInfo, models.CASCADE, verbose_name="学习课程")
...
class UserComment(models.Model):
    comment_man = models.ForeignKey(UserProfile, models.CASCADE, verbose_name="评论用户")
    comment_course = models.ForeignKey(CourseInfo, models.CASCADE, verbose_name="评论课程")
