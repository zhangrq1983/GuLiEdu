...
class CourseInfo(models.Model):
    ...
    orginfo = models.ForeignKey(OrgInfo, models.CASCADE, verbose_name="所属机构")
    teacherinfo = models.ForeignKey(TeacherInfo, models.CASCADE, verbose_name="所属讲师")
...
class LessonInfo(models.Model):
    ...
    courseinfo = models.ForeignKey(CourseInfo, models.CASCADE, verbose_name="所属课程")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class VideoInfo(models.Model):
    ...
    lessoninfo = models.ForeignKey(LessonInfo, models.CASCADE, verbose_name="所属章节")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
